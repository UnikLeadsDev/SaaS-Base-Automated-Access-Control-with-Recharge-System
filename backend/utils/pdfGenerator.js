...
class PDFGenerator {
  ...
  //       // .text(`GSTIN: ${invoice.gstin}`, 50, 160);
  ...
  //         .text(`Time: ${createdAt.toLocaleTimeString('en-US', { hour: '2-digit', minute: '2-digit' })}`, rightX, 130);
  ...
  //         .text('Sr. No.', colX.srNo, tableTop)
  //         .text('Description', colX.description, tableTop)
  //         .text('Qty', colX.qty, tableTop)
  //         .text('Amount', colX.amount, tableTop)
  //         .text('GST', colX.gst, tableTop)
  ...
  //         .text('1', colX.srNo, y)
  //         .text('Wallet Recharge Payment for SAAS Services', colX.description, y, { width: 230 })
  //         .text('1', colX.qty, y)
  //         .text(`Rs. ${subtotal.toFixed(2)}`, colX.amount, y)
  //         .text('18%', colX.gst, y)
  //         .text(`Rs. ${total.toFixed(2)}`, colX.total, y);
