...
// ✅ NEW: Import QR icon from lucide-react
import { QrCode } from "lucide-react"; // Added line
  ...
  return (
    <div className="bg-gray-100 p-4 rounded-lg border-2 border-dashed border-gray-300">
      <h3 className="text-lg font-semibold mb-4 text-gray-800 flex items-center gap-2">
        {/* ✅ Replaced old image with QR icon */}
        <QrCode className="h-5 w-5 text-blue-600" /> 🔧 Payment Debug Panel (Development Only)
      </h3>
